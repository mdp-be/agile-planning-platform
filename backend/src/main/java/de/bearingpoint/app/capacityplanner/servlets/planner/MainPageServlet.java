package de.bearingpoint.app.capacityplanner.servlets.planner;
...
import de.bearingpoint.app.capacityplanner.impl.PluginInitializer;
...
public class MainPageServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse response) throws IOException {
        ...
        renderer.render("pages/main_page.vm", params, response.getWriter());
    }
