package de.bearingpoint.app.capacityplanner.init;
...
public class IssueTypePluginInitializer implements LifecycleAware {
    ...
    private static String requestIssueTypeID;
    ...
    private void addIssueTypeToScheme() {
        ...
        if (issueTypes.stream().noneMatch(x -> x.getName().equals("Request"))) {
            ...
            setRequestIssueTypeID(issueType.getId());
    ...
    private void setRequestIssueTypeID(String requestIssueTypeID) {
        this.requestIssueTypeID = requestIssueTypeID;
    }

    public static String getRequestIssueTypeID() {
        return requestIssueTypeID;
    }
}